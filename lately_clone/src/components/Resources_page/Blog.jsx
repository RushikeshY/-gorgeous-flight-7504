...
const Blog = () => {
  ...
  return (
   ...
   <h1 style={{color:"white"}}>Lately Blog</h1>
      ...
      Product Updates, News, Marketing Tips & the Occasional Spreadsheet-Hating Tangent
      </h4>
      </div>
   <div className= "d-flex align-content-around flex-wrap">

    <Cards data={bdata} style={{ boxShadow: "rgba(0, 0, 0, 0.3) 0px 19px 38px, rgba(0, 0, 0, 0.22) 0px 15px 12px" }}/>
